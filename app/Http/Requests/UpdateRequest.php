...
class UpdateRequest extends FormRequest
{
    ...
    /**
     * Update the personal and related models using the validated data.
     *
     * @param  int  $id
     * @return \App\Http\Resources\PersonalResource
     */
    public function updateData($id)
    {
        ...
        $personal->employmentInfo()->update([
        ...
        $personal->statusInfo()->update([
            'status' => $data['status'],
            'submitted_nbi' => $data['submitted_nbi'],
        ]);

        $personal->disbursementInfo()->update([
        ...
        return $personal->load('employmentInfo', 'statusInfo', 'disbursementInfo', 'repaymentInfo');
    }
    /**
